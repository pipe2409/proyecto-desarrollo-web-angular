...
export const ROOMS_DATA: TipoHabitacion[] = [
...

  {
    ...
    description: 'Perfecta para compartir momentos especiales con más espacio, comodidad y servicios pensados para todos.',
    price: 620000,
    imageUrl: 'https://images.unsplash.com/photo-1670523865335-62e1d0136601?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8aGFiaXRhY2lvbiUyMGNvbiUyMHBpc2NpbmF8ZW58MHx8MHx8fDA%3D',
    capacity: '4 huéspedes',
    beds: '2 camas dobles',
    amenities: ['Wifi', 'TV', 'Sala auxiliar', 'Baño privado'],
  }
